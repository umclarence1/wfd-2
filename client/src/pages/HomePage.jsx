...
export default function HomePage() {
  return (
    <div>
      <div className="relative overflow-hidden bg-blue-600 px-5 py-7 text-white sm:px-8 sm:py-9">
        <div
        ...
        <div
          ...
          aria-hidden="true"
        />
        <h1 className="relative mx-auto max-w-7xl text-xl font-extrabold leading-snug tracking-tight sm:text-2xl md:text-3xl">
